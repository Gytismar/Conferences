...
<div>
    ...
    <input id="conference-date-input" type="date" name="conference_date" value="{{ old('conference_date', optional($conference ?? null)->conference_date) }}">
</div>
<div>
...
<div>
    ...
    <input id="attending-people-count-input" type="number" name="attending_people_count" value="{{ old('attending_people_count', optional($conference ?? null)->attending_people_count) }}">
</div>
@if($errors->any())
    <div>
        <ul>
