        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="conference-date-input" class="form-label">Conference Date</label>
                    ...
                    <div class="mb-3">
                        <label for="attending-people-count-input" class="form-label">Attending People Count</label>
